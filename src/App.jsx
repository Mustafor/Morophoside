...
function App() {
  return (
    <>
      <div
        data-aos="fade-down"
        className="px-[170px] py-[28px] flex items-center justify-between"
      >
        <a href="#">
        ...
        <ul className="flex items-center gap-[22px]">
          <li>
            <a
              className="text-[16px] text-[#666666D9] font-medium hover:text-red-600 duration-300"
              href="#"
            >
              Academy
            </a>
      ...
      <div className="px-[170px] flex items-center justify-between">
        <div data-aos="fade-right" className="py-[50px]">
          <h2 className="w-[522px] text-[48px] font-bold text-[#4A4A4A] mb-[20px]">
            Exploring cities through data analysis and visualization
          </h2>
          <p className="w-[512px] text-[18px] text-[#434A54]">
      ...
      <div className="px-[170px] flex items-center gap-[15px] justify-between">
        ...
        <div data-aos="fade-left">
          <h2 className="w-[437px] text-[36px] font-bold text-[#4A4A4A] mb-[15px]">
            We research, design, and develop
          </h2>
          <p className="w-[458px] text-[18px] mb-[21px] text-[#434A54]">
            Our portfolio ranges from interactive web maps and information
            graphics to custom software tools for data analysis and
            visualization.
          </p>
          <a
            className="text-[16px] text-[#1D6FF3] font-medium hover:text-green-600 duration-300"
            href="#"
          >
            View Projects
          </a>
      ...
      <div className="px-[170px] flex items-center justify-between gap-[30px]">
        <div data-aos="fade-right" className="py-[50px]">
          <h2 className="text-[36px] font-bold text-[#4A4A4A] mb-[20px]">
            Learn with Morphocode
          </h2>
          <p className="w-[500px] text-[18px] text-[#434A54] mb-[52px]">
            Morphocode Academy is an online school that covers topics in data
            visualization, creative coding, and urban informatics.
          </p>
          <a
            href="#"
            className="text-[16px] font-medium text-[#1D6FF3] hover:text-green-600 duration-300"
          >
            Start Learning
          </a>
        </div>
      ...
      <div data-aos="zoom-in" className="px-[170px]">
        <h2 className="text-[24px] font-bold mb-[11px] text-[#4A4A4A]">
          From the blog
        </h2>
        <ul className="flex flex-wrap justify-between gap-[30px]">
          <li className="w-[300px]">
            ...
            <div className="p-4 ">
              <strong className="text-[24px] block mb-[15px] text-[#4A4A4A] w-[205px]">
                The power of interactive tools
              </strong>
              <p className="w-[237px] text-[#434A54] text-[15px]">
          ...
          <li className="w-[300px]">
            ...
            <div className="p-4 ">
              ...
              <p className="w-[237px] text-[#434A54] text-[15px]">
                The most common ways to visually organize information are based
                on location and time. In this interactive story, [...]
              </p>
            </div>
          </li>
          <li className="w-[300px]">
      ...
      <div
        data-aos="zoom-out"
        className="px-[170px] bg-[#EEEEEE] py-[30px] flex items-center justify-center gap-[175px]"
      >
        <div>
          <h2 className="text-[36px] font-bold text-[#4A4A4A] mb-[18px]">
            Start Learning
          </h2>
          <p className="w-[463px] text-[#434A54] text-[18px]">
        ...
        <div className="relative">
          <input
            className="bg-white w-full text-[#979797] outline-none hover:shadow-2xl font-medium text-[18px] py-[8px] px-[7px] pr-[130px]"
            type="text"
            placeholder="Enter your email"
          />
          <button className="absolute right-0 top-0 w-[121px] py-[6px] bg-[#1D6FF3] border-[2px] border-[#1D6FF3] text-[18px] font-bold text-white hover:bg-transparent hover:border-[2px] duration-300 hover:text-[#1D6FF3]">
            Subscribe
          </button>
        </div>
      </div>
